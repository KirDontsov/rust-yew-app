	...
	html! {
	   ...
	   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
		  <ul class="space-y-2 font-medium">
			...
			<SidebarItem to={Route::FirmsPage} active={location.path() == "/firms"}>
			   <svg class={format!("w-5 h-5 transition duration-75 text-gray-400 {}", if location.path() == "/firms" {"text-indigo-400 group-hover:text-indigo-300"} else {"text-gray-400 group-hover:text-white"})} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
				  <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z"/>
			   </svg>
			   <span class="flex-1 ml-3 whitespace-nowrap">{"Фирмы"}</span>
			</SidebarItem>
			<SidebarItem to={Route::FirmsInfoPage} active={location.path() == "/firms_info"}>
				<svg class={format!("w-5 h-5 transition duration-75 text-gray-400 {}", if location.path() == "/firms_info" {"text-indigo-400 group-hover:text-indigo-300"} else {"text-gray-400 group-hover:text-white"})} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
				  <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z"/>
			   </svg>
				<span class="flex-1 ml-3 whitespace-nowrap">{"Фирмы инфо"}</span>
			</SidebarItem>
				<li>
